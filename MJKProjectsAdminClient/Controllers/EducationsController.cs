...
namespace MJKProjectsAdminClient.Controllers
{
    public class EducationsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Complete,From,Till,ID,CreatedAt")] Education education)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,Complete,From,Till,ID,CreatedAt")] Education education)
        {
            if (id != education.ID)
            {
                return NotFound();
