...
namespace MJKProjectsTests.Client.Models
{
    public class BlogPostTest
    {
        ...
        public void TestProjectDescriptionToShorter()
        {
            ...
            Assert.IsTrue(blogPost.ShortContent().Length == 350);
        }
    }
}
